...
<body class="bg-white">
    ...
    <nav class="navbar navbar-expand-lg text-bg-dark sticky-top border-bottom border-warning border-4" data-bs-theme="dark">
        <div class="container-fluid px-4 py-1">
            <div class="d-flex align-items-center">
                ...
                <span class="ms-3 ps-3 border-start border-secondary text-secondary d-none d-md-inline small">Mode Revisi</span>
            </div>

            <div class="ms-auto d-flex align-items-center gap-3">
                <a href="{{ url('/myblog') }}" class="btn btn-link text-white text-decoration-none d-none d-sm-inline-block small">Batalkan Perubahan</a>
                @auth
                    <div class="dropdown">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-xl-2 bg-light border-end min-vh-100 d-none d-lg-block p-4">
                <div class="sticky-top" style="top: 100px;">
                    <h6 class="fw-bold text-uppercase text-secondary small mb-4" style="letter-spacing: 1px;">Detail Artikel</h6>
                    ...
                    <div class="p-3 bg-warning-subtle rounded-3 border border-warning border-opacity-25 small text-dark">
                        <i class="bi bi-info-circle-fill me-1"></i> Perubahan yang Anda simpan akan langsung terlihat oleh pembaca.
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-9 col-xl-10 p-0">
                <form method="POST" action="{{ route('myblog.update', $blog->id_blog) }}" enctype="multipart/form-data" id="articleForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="bg-light border-bottom position-relative" style="min-height: 200px;">
                        ...
                        @if(!$blog->cover)
                            <div id="placeholderText" class="d-flex flex-column align-items-center justify-content-center py-5 text-secondary">
                    ...
                    <div class="p-4 p-md-5 border-bottom">
                        <div class="mx-auto" style="max-width: 850px;">
                            <label class="text-uppercase small fw-bold text-secondary mb-2 d-block" style="letter-spacing: 1px;">Judul Artikel</label>
                    ...
                    <div class="p-4 p-md-5 mb-5">
                        <div class="mx-auto" style="max-width: 850px;">
                            <label class="text-uppercase small fw-bold text-secondary mb-3 d-block" style="letter-spacing: 1px;">Isi Konten</label>

                            {{-- Textarea hidden, diisi saat submit --}}
                            <textarea name="content" id="editorContent" class="d-none">{{ old('content', $blog->content) }}</textarea>
    ...
    <script>
        ...
        updateReadTime(); // hitung saat pertama load
