        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-xl-2 bg-light border-end min-vh-100 d-none d-lg-block p-4">
                <div class="sticky-top pt-4" style="top:80px;">
                    ...
                    <div class="p-3 bg-white rounded-3 border shadow-sm small text-secondary">
                        ...
                        Gunakan gambar cover dengan resolusi minimal 1200×630 agar terlihat profesional.
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-9 col-xl-10 p-0">
                <form method="POST" action="{{ route('myblog.store') }}" enctype="multipart/form-data"
                    ...
                    <!-- Cover Upload -->
                    <div class="position-relative bg-light border-bottom text-center overflow-hidden"
                        style="height:350px;">
                        <img id="coverPreview"
                            class="w-100 h-100 object-fit-cover d-none animate__animated animate__fadeIn">

                        <div id="uploadPlaceholder"
                            class="position-absolute top-50 start-50 translate-middle w-100">
                            <label for="coverInput" class="text-secondary" role="button">
                        ...
                        <div id="changeCoverBtn" class="position-absolute bottom-0 end-0 m-4 d-none">
                            <label for="coverInput"
                                class="btn btn-dark btn-sm rounded-pill px-3 opacity-75 shadow-sm">
                    ...
                    <div class="p-4 p-md-5 border-bottom">
                        <div class="mx-auto" style="max-width:800px;">
                            <input type="text" name="judul_artikel"
                                class="form-control border-0 fs-1 fw-bold p-0 shadow-none
                    ...
                    <div class="p-4 p-md-5 mb-5">
                        <div class="mx-auto" style="max-width:800px;">
                            <textarea name="content" id="editorContent"
                                class="d-none">{{ old('content') }}</textarea>
